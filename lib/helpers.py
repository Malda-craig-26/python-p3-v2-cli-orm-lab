...
def create_employee():
    try:
        ...
        department_id = int(input("Enter the employee'sdepartment ID: "))
...
def list_department_employees():
    ...
    department = Department.find_by_id(department_id)
    if department:
        employees = Employee.get_by_department(department.id)
        if employees:
            for employee in employees:
                print(employee)
        else:
            print(f'No employees found in department {department.id}')
    else:
        print(f'Department {department_id} not found')